//===-- RepairBrokenNullCheck/RepairBrokenNullCheckActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the RepairBrokenNullCheckFixer class which
...
///
class RepairBrokenNullCheckFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  RepairBrokenNullCheckFixer(unsigned &AcceptedChanges, Transform &Owner);
