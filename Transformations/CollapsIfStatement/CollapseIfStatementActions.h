//===-- CollapseIfStatement/CollapseIfStatementActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the CollapseIfStatementFixer class which
...
///
class CollapseIfStatementFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  CollapseIfStatementFixer(unsigned &AcceptedChanges, Transform &Owner);
