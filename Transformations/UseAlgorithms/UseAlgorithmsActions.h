//===-- UseAlgorithms/UseAlgorithmsActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseAlgorithmsFixer class which
...
///
class UseAlgorithmsFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseAlgorithmsFixer(unsigned &AcceptedChanges, Transform &Owner);
