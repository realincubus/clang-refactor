...
extern const char *MatcherExtractMethodID;
extern const char *MatcherExtractMethodCompoundID;
...
clang::ast_matchers::StatementMatcher makeExtractMethodMatcher();
clang::ast_matchers::DeclarationMatcher makeExtractMethodMatcherCompound();
