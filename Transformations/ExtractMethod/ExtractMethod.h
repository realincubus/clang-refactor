//===-- ExtractMethod/ExtractMethod.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the ExtractMethodTransform
...
class ExtractMethodTransform : public Transform {
public:
  ExtractMethodTransform(const TransformOptions &Options)
      : Transform("ExtractMethod", Options) {}
