//===-- UseMathConstants/UseMathConstantsActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseMathConstantsFixer class which
...
///
class UseMathConstantsFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseMathConstantsFixer(unsigned &AcceptedChanges, Transform &Owner);
