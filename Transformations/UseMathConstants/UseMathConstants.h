//===-- UseMathConstants/UseMathConstants.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseMathConstantsTransform
...
class UseMathConstantsTransform : public Transform {
public:
  UseMathConstantsTransform(const TransformOptions &Options)
      : Transform("UseMathConstants", Options) {}
