//===-- UseSwap/UseSwapActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseSwapFixer class which
...
///
class UseSwapFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseSwapFixer(unsigned &AcceptedChanges, Transform &Owner);
