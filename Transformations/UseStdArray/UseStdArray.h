//===-- UseStdArray/UseStdArray.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseStdArrayTransform
...
class UseStdArrayTransform : public Transform {
public:
  UseStdArrayTransform(const TransformOptions &Options)
      : Transform("UseStdArray", Options) {}
