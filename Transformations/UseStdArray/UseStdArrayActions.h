//===-- UseStdArray/UseStdArrayActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseStdArrayFixer class which
...
///
class UseStdArrayFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseStdArrayFixer(unsigned &AcceptedChanges, Transform &Owner);
