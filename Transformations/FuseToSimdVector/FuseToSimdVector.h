//===-- FuseToSimdVector/FuseToSimdVector.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the FuseToSimdVectorTransform
...
class FuseToSimdVectorTransform : public Transform {
public:
  FuseToSimdVectorTransform(const TransformOptions &Options)
      : Transform("FuseToSimdVector", Options) {}
