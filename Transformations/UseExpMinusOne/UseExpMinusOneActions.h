//===-- UseExpMinusOne/UseExpMinusOneActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseExpMinusOneFixer class which
...
///
class UseExpMinusOneFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseExpMinusOneFixer(unsigned &AcceptedChanges, Transform &Owner);
