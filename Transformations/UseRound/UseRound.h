//===-- UseRound/UseRound.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseRoundTransform
...
class UseRoundTransform : public Transform {
public:
  UseRoundTransform(const TransformOptions &Options)
      : Transform("UseRound", Options) {}
