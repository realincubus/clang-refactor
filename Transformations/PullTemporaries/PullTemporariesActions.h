//===-- PullTemporaries/PullTemporariesActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the PullTemporariesFixer class which
...
///
class PullTemporariesFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  PullTemporariesFixer(unsigned &AcceptedChanges, Transform &Owner);
