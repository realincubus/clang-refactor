//===-- PullTemporaries/PullTemporaries.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the PullTemporariesTransform
...
class PullTemporariesTransform : public Transform {
public:
  PullTemporariesTransform(const TransformOptions &Options)
      : Transform("PullTemporaries", Options) {}
