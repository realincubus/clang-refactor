//===-- UseVector/UseVector.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseVectorTransform
...
class UseVectorTransform : public Transform {
public:
  UseVectorTransform(const TransformOptions &Options)
      : Transform("UseVector", Options) {}
