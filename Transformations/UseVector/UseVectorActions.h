//===-- UseVector/UseVectorActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseVectorFixer class which
...
///
class UseVectorFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseVectorFixer(unsigned &AcceptedChanges, Transform &Owner);
