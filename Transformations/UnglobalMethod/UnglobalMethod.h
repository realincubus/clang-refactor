//===-- UnglobalMethod/UnglobalMethod.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UnglobalMethodTransform
...
class UnglobalMethodTransform : public Transform {
public:
  UnglobalMethodTransform(const TransformOptions &Options)
      : Transform("UnglobalMethod", Options) {}
