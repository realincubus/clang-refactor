//===-- UseFusedMultiplyAdd/UseFusedMultiplyAddActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseFusedMultiplyAddFixer class which
...
///
class UseFusedMultiplyAddFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseFusedMultiplyAddFixer(unsigned &AcceptedChanges, Transform &Owner);
