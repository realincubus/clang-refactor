//===-- UseEmplace/UseEmplace.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseEmplaceTransform
...
class UseEmplaceTransform : public Transform {
public:
  UseEmplaceTransform(const TransformOptions &Options)
      : Transform("UseEmplace", Options) {}
