//===-- UseUnaryOperator/UseUnaryOperatorActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseUnaryOperatorFixer class which
...
///
class UseUnaryOperatorFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseUnaryOperatorFixer(unsigned &AcceptedChanges, Transform &Owner);
