//===-- UseUnaryOperator/UseUnaryOperator.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseUnaryOperatorTransform
...
class UseUnaryOperatorTransform : public Transform {
public:
  UseUnaryOperatorTransform(const TransformOptions &Options)
      : Transform("UseUnaryOperator", Options) {}
