//===-- UseHypot/UseHypotActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseHypotFixer class which
...
///
class UseHypotFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseHypotFixer(unsigned &AcceptedChanges, Transform &Owner);
