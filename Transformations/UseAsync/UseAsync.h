//===-- UseAsync/UseAsync.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseAsyncTransform
...
class UseAsyncTransform : public Transform {
public:
  UseAsyncTransform(const TransformOptions &Options)
      : Transform("UseAsync", Options) {}
