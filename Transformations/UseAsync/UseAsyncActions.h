//===-- UseAsync/UseAsyncActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseAsyncFixer class which
...
///
class UseAsyncFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseAsyncFixer(unsigned &AcceptedChanges, Transform &Owner);
