//===-- MoveToFirstUsage/MoveToFirstUsage.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the MoveToFirstUsageTransform
...
class MoveToFirstUsageTransform : public Transform {
public:
  MoveToFirstUsageTransform(const TransformOptions &Options)
      : Transform("MoveToFirstUsage", Options) {}
