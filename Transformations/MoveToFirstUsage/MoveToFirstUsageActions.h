//===-- MoveToFirstUsage/MoveToFirstUsageActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the MoveToFirstUsageFixer class which
...
///
class MoveToFirstUsageFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  MoveToFirstUsageFixer(unsigned &AcceptedChanges, Transform &Owner);
