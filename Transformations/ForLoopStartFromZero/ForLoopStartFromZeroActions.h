//===-- ForLoopStartFromZero/ForLoopStartFromZeroActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the ForLoopStartFromZeroFixer class which
...
///
class ForLoopStartFromZeroFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  ForLoopStartFromZeroFixer(unsigned &AcceptedChanges, Transform &Owner);
