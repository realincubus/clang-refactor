//===-- UnInvertLogic/UnInvertLogic.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UnInvertLogicTransform
...
class UnInvertLogicTransform : public Transform {
public:
  UnInvertLogicTransform(const TransformOptions &Options)
      : Transform("UnInvertLogic", Options) {}
