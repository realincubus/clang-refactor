//===-- UnInvertLogic/UnInvertLogicActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UnInvertLogicFixer class which
...
///
class UnInvertLogicFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UnInvertLogicFixer(unsigned &AcceptedChanges, Transform &Owner);
