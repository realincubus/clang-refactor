//===-- UseFullyQualifiedTypes/UseFullyQualifiedTypesActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseFullyQualifiedTypesFixer class which
...
///
class UseFullyQualifiedTypesFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseFullyQualifiedTypesFixer(unsigned &AcceptedChanges, Transform &Owner);
