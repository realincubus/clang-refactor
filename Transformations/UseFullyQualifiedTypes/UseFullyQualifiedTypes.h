//===-- UseFullyQualifiedTypes/UseFullyQualifiedTypes.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseFullyQualifiedTypesTransform
...
class UseFullyQualifiedTypesTransform : public Transform {
public:
  UseFullyQualifiedTypesTransform(const TransformOptions &Options)
      : Transform("UseFullyQualifiedTypes", Options) {}
