//===-- NestedIndexRenamer/NestedIndexRenamerActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the NestedIndexRenamerFixer class which
...
///
class NestedIndexRenamerFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  NestedIndexRenamerFixer(unsigned &AcceptedChanges, Transform &Owner);
