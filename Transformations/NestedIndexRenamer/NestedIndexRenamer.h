//===-- NestedIndexRenamer/NestedIndexRenamer.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the NestedIndexRenamerTransform
...
class NestedIndexRenamerTransform : public Transform {
public:
  NestedIndexRenamerTransform(const TransformOptions &Options)
      : Transform("NestedIndexRenamer", Options) {}
