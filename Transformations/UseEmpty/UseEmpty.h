//===-- UseEmpty/UseEmpty.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseEmptyTransform
...
class UseEmptyTransform : public Transform {
public:
  UseEmptyTransform(const TransformOptions &Options)
      : Transform("UseEmpty", Options) {}
