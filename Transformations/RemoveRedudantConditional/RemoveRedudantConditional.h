//===-- RemoveRedudantConditional/RemoveRedudantConditional.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the RemoveRedudantConditionalTransform
...
class RemoveRedudantConditionalTransform : public Transform {
public:
  RemoveRedudantConditionalTransform(const TransformOptions &Options)
      : Transform("RemoveRedudantConditional", Options) {}
