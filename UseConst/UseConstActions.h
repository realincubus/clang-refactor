//===-- UseConst/UseConstActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseConstFixer class which
...
///
class UseConstFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseConstFixer(unsigned &AcceptedChanges, Transform &Owner);
