//===-- UseConst/UseConst.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseConstTransform
...
class UseConstTransform : public Transform {
public:
  UseConstTransform(const TransformOptions &Options)
      : Transform("UseConst", Options) {}
