//===-- ForLoopStartFromZero/ForLoopStartFromZero.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the ForLoopStartFromZeroTransform
...
class ForLoopStartFromZeroTransform : public Transform {
public:
  ForLoopStartFromZeroTransform(const TransformOptions &Options)
      : Transform("ForLoopStartFromZero", Options) {}
