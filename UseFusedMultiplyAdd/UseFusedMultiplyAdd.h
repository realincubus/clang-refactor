//===-- UseFusedMultiplyAdd/UseFusedMultiplyAdd.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseFusedMultiplyAddTransform
...
class UseFusedMultiplyAddTransform : public Transform {
public:
  UseFusedMultiplyAddTransform(const TransformOptions &Options)
      : Transform("UseFusedMultiplyAdd", Options) {}
