//===-- RepairBrokenNullCheck/RepairBrokenNullCheck.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the RepairBrokenNullCheckTransform
...
class RepairBrokenNullCheckTransform : public Transform {
public:
  RepairBrokenNullCheckTransform(const TransformOptions &Options)
      : Transform("RepairBrokenNullCheck", Options) {}
