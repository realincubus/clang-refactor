//===-- TransformationTemplate/TransformationTemplate.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the TransformationTemplateTransform
...
class TransformationTemplateTransform : public Transform {
public:
  TransformationTemplateTransform(const TransformOptions &Options)
      : Transform("TransformationTemplate", Options) {}
