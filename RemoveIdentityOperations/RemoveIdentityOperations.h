//===-- RemoveIdentityOperations/RemoveIdentityOperations.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the RemoveIdentityOperationsTransform
...
class RemoveIdentityOperationsTransform : public Transform {
public:
  RemoveIdentityOperationsTransform(const TransformOptions &Options)
      : Transform("RemoveIdentityOperations", Options) {}
