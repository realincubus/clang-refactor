//===-- UseSwap/UseSwap.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseSwapTransform
...
class UseSwapTransform : public Transform {
public:
  UseSwapTransform(const TransformOptions &Options)
      : Transform("UseSwap", Options) {}
