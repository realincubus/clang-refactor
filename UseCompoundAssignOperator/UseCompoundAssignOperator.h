//===-- UseCompoundAssignOperator/UseCompoundAssignOperator.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseCompoundAssignOperatorTransform
...
class UseCompoundAssignOperatorTransform : public Transform {
public:
  UseCompoundAssignOperatorTransform(const TransformOptions &Options)
      : Transform("UseCompoundAssignOperator", Options) {}
