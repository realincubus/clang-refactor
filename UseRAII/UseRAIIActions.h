//===-- UseRAII/UseRAIIActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseRAIIFixer class which
...
///
class UseRAIIFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseRAIIFixer(unsigned &AcceptedChanges, Transform &Owner);
