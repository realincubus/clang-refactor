//===-- UseAlgorithms/UseAlgorithms.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseAlgorithmsTransform
...
class UseAlgorithmsTransform : public Transform {
public:
  UseAlgorithmsTransform(const TransformOptions &Options)
      : Transform("UseAlgorithms", Options) {}
