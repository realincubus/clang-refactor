//===-- FuseToSimdVector/FuseToSimdVectorActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the FuseToSimdVectorFixer class which
...
///
class FuseToSimdVectorFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  FuseToSimdVectorFixer(unsigned &AcceptedChanges, Transform &Owner);
