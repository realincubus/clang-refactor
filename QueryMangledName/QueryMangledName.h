//===-- QueryMangledName/QueryMangledName.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the QueryMangledNameTransform
...
class QueryMangledNameTransform : public Transform {
public:
  QueryMangledNameTransform(const TransformOptions &Options)
      : Transform("QueryMangledName", Options) {
	  priority = 50;
      }
