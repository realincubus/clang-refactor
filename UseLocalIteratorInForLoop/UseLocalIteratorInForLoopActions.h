//===-- UseLocalIteratorInForLoop/UseLocalIteratorInForLoopActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseLocalIteratorInForLoopFixer class which
...
///
class UseLocalIteratorInForLoopFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseLocalIteratorInForLoopFixer(unsigned &AcceptedChanges, Transform &Owner);
