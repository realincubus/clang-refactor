//===-- UseExpMinusOne/UseExpMinusOne.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseExpMinusOneTransform
...
class UseExpMinusOneTransform : public Transform {
public:
  UseExpMinusOneTransform(const TransformOptions &Options)
      : Transform("UseExpMinusOne", Options) {}
