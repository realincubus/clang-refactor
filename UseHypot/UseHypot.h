//===-- UseHypot/UseHypot.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UseHypotTransform
...
class UseHypotTransform : public Transform {
public:
  UseHypotTransform(const TransformOptions &Options)
      : Transform("UseHypot", Options) {}
