//===-- UsePowerOperator/TransformationTemplateActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UsePowerOperatorFixer class which
...
///
class UsePowerOperatorFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UsePowerOperatorFixer(unsigned &AcceptedChanges,
