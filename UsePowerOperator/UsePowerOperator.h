//===-- UsePowerOperator/TransformationTemplate.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the UsePowerOperatorTransform
...
class UsePowerOperatorTransform : public Transform {
public:
  UsePowerOperatorTransform(const TransformOptions &Options)
      : Transform("UsePowerOperator", Options) {}
