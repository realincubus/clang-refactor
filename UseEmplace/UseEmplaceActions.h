//===-- UseEmplace/UseEmplaceActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseEmplaceFixer class which
...
///
class UseEmplaceFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseEmplaceFixer(unsigned &AcceptedChanges, Transform &Owner);
