...
extern const char *MatcherQueryMangledNameID;
...
clang::ast_matchers::DeclarationMatcher makeQueryMangledNameMatcher();
clang::ast_matchers::StatementMatcher makeQueryMangledNameMatcherRef();
