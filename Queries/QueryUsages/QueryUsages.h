//===-- QueryUsages/QueryUsages.h - C++11 nullptr migration -------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file provides the definition of the QueryUsagesTransform
...
class QueryUsagesTransform : public Transform {
public:
  QueryUsagesTransform(const TransformOptions &Options)
      : Transform("QueryUsages", Options) {}
