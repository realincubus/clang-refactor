...
extern const char *MatcherQueryUsagesID;

clang::ast_matchers::StatementMatcher makeQueryUsagesMatcher();
clang::ast_matchers::DeclarationMatcher makeQueryDeclarationMatcher();
