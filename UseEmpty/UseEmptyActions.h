//===-- UseEmpty/UseEmptyActions.h - Matcher callback ----------*- C++ -*-===//
//
...
///
/// \file
/// \brief This file contains the declaration of the UseEmptyFixer class which
...
///
class UseEmptyFixer : public clang::ast_matchers::MatchFinder::MatchCallback {
public:
  UseEmptyFixer(unsigned &AcceptedChanges, Transform &Owner);
